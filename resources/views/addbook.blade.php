...
<head>
    ...
    <style>
        ...
        nav {
            background-color: rgba(66, 43, 32, 0.95); /* Alterado para tom de marrom mais claro */
            color: #efebe9;
            padding: 1rem;
            display: flex;
        ...
        nav a:hover {
            color: #d7ccc8; /* Tom mais claro ao passar o mouse */
        }
        .container {
            max-width: 600px;
            margin: 30px auto;
            ...
            border-radius: 10px;
            background-color: rgba(66, 43, 32, 0.85); /* Alterado para tom de marrom mais claro */
